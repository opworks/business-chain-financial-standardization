...
class FixedColumnProcessor:
    ...
    def __init__(self, base_path: str):
        ...
        self.normalized_columns = [
            ...
            'Hydrovac Cleaning', 'PPE & Safety', 'Security', 'Tools', '161 TOTAL INDIRECT EXPENSES',
    ...
    def create_client_specific_mapping(self, client_name):
        """Create mapping specific to the client."""
        if self.master_df is None:
            return {}
        
        mapping = {}
        
        # Filter mappings for this specific client first
            ...
            for norm_name in self.normalized_columns:
                ...
                for _, row in matching_rows.iterrows():
                    ...
                    if pd.notna(original_col):
                        if original_col not in mapping:  # Don't overwrite client-specific mappings
        ...
        for client in clients:
            ...
            for original_col, normalized_col in mapping.items():
                if original_col in client_data.columns and normalized_col in sorted_normalized:
                    ...
                    # Copy data from original column to normalized column for this client only
                    result_df.loc[client_indices, normalized_col] = client_data[original_col].values
                    mapped_count += 1
